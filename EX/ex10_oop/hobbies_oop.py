...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    sorted_by_name = sorted(people_list, key=lambda x: x.first_name + x.last_name)
    sorted_by_hobbies = sorted(sorted_by_name, key=lambda x: len(x.hobbies), reverse=True)
    return sorted_by_hobbies
...
def sort_by_least_hobbies(people_list: list) -> list:
    ...
    """
    sorted_by_name = sorted(people_list, key=lambda x: x.first_name + x.last_name)
    sorted_by_hobbies = sorted(sorted_by_name, key=lambda x: len(x.hobbies))
    return sorted_by_hobbies
